        ...
        {totalPages > 1 && (
          <div className="flex justify-center items-center gap-4 mt-10">
            <Link
              ...
              className={`px-4 py-2 rounded border text-sm font-medium ${page === 1 ? "bg-gray-200 text-gray-400 cursor-not-allowed" : "bg-white text-blue-600 hover:bg-blue-50"}`}
            ...
            <Link
              ...
              className={`px-4 py-2 rounded border text-sm font-medium ${page === totalPages ? "bg-gray-200 text-gray-400 cursor-not-allowed" : "bg-white text-blue-600 hover:bg-blue-50"}`}
